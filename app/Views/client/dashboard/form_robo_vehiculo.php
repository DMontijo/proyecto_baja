<div class="row" method="POST">
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		...
		<input class="form-control" type="file" id="foto_vehiculo" name="foto_vehiculo">
	</div>

	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		<label for="documento_vehiculo" class="form-label fw-bold">Documento del vehículo:</label>
		<input class="form-control" type="file" id="documento_vehiculo" name="documento_vehiculo">
	</div>
</div>
