<div class="row" method="POST">
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		...
		<select class="form-select" id="estado_extranjero_vehiculo" name="estado_extranjero_vehiculo" style="display: none;">
			<option selected disabled value="">Selecciona el estado</option>
	...
	<div class="col-12 col-sm-12 col-md-12 col-lg-8 mb-3">
		...
		<div class="form-check form-check-inline">
			<input class="form-check-input" type="radio" name="seguro_vigente_vehiculo" id="SI" value="S">
			<label class="form-check-label" for="flexRadioDefault1">Si</label>
		</div>
		<div class="form-check form-check-inline">
			<input class="form-check-input" type="radio" name="seguro_vigente_vehiculo" id="NO" value="N">
			<label class="form-check-label" for="flexRadioDefault2">No</label>
		</div>
		<div class="form-check form-check-inline">
			<input class="form-check-input" type="radio" name="seguro_vigente_vehiculo" id="DESCONOCIDO" value="D">
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		...
		<div class="form-check">
			<input class="form-check-input" type="radio" name="transmision_vehiculo" id="AUTOMATICA" value="A">
			<label class="form-check-label" for="flexRadioDefault1">Automática</label>
		</div>
		<div class="form-check">
			<input class="form-check-input" type="radio" name="transmision_vehiculo" id="MANUAL" value="M">
			<label class="form-check-label" for="flexRadioDefault2">Manual</label>
		</div>
		<div class="form-check">
			<input class="form-check-input" type="radio" name="transmision_vehiculo" id="DUAL" value="D">
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		...
		<br>
		<div class="form-check">
			<input class="form-check-input" type="radio" name="traccion_vehiculo" id="DOBLE" value="D">
			<label class="form-check-label" for="flexRadioDefault1">Doble</label>
		</div>
		<div class="form-check">
			<input class="form-check-input" type="radio" name="traccion_vehiculo" id="SENCILLA" value="S">
...
<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		...
		<input class="form-control" type="file" id="documento_vehiculo" name="documento_vehiculo" accept="image/jpeg, image/jpg, image/png, .doc, .pdf">
	</div>
...
<script>
	...
	document.querySelector('#estado_vehiculo').addEventListener('change', (e) => {
		if (e.target.value == 33) {
			let select_estado = document.querySelector('#estado_vehiculo');
			let select_estado_extr = document.querySelector('#estado_extranjero_vehiculo');
			document.getElementById("estado_extranjero_vehiculo").style.display="block";
			document.getElementById("estado_vehiculo").style.display="none";
	...
	document.querySelector('#estado_extranjero_vehiculo').addEventListener('change', (e) => {
		if (e.target.value == 0) {
			let select_estado = document.querySelector('#estado_vehiculo');
			let select_estado_extr = document.querySelector('#estado_extranjero_vehiculo');
			document.getElementById("estado_extranjero_vehiculo").style.display="none";
			document.getElementById("estado_vehiculo").style.display="block";
		}
	});
