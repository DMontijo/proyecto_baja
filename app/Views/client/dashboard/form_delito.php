<div class="row">
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		...
		<select class="form-select" id="delito" name="delito" required autofocus>
			...
			<option value="ABUSO DE RETENCIÓN">ABUSO DE RETENCIÓN</option>
			<option value="ABUSO SEXUAL">ABUSO SEXUAL</option>
			<option value="AMENAZAS - EJECUTADAS CON ARMA DE FUEGO, ARMA BLANCA U OBJETO CONTUNDENTE.">AMENAZAS - EJECUTADAS CON ARMA DE FUEGO, ARMA BLANCA U OBJETO CONTUNDENTE.</option>
			<option value="ALLANAMIENTO DE MORADA, EJECUTADO CON VIOLENCIA.">ALLANAMIENTO DE MORADA, EJECUTADO CON VIOLENCIA.</option>
			<option value="ATAQUES A LA VÍAS DE COMUNICACIÓN Y A LOS MEDIOS DE TRANSPORTE.">ATAQUES A LA VÍAS DE COMUNICACIÓN Y A LOS MEDIOS DE TRANSPORTE.</option>
			<option value="BIGAMIA">BIGAMIA</option>
			<option value="COBRANZA ILEGITIMA.">COBRANZA ILEGITIMA.</option>
			<option value="CORRUPCIÓN">CORRUPCIÓN</option>
			<option value="DAÑO EN PROPIEDAD AJENA">DAÑO EN PROPIEDAD AJENA</option>
			<option value="DAÑO EN PROPIEDAD AJENA AGRAVADO POR INCENDIO">DAÑO EN PROPIEDAD AJENA AGRAVADO POR INCENDIO</option>
			<option value="DAÑO EN PROPIEDAD AJENA AGRAVADO POR INUNDACIÓN">DAÑO EN PROPIEDAD AJENA AGRAVADO POR INUNDACIÓN</option>
			<option value="DAÑO EN PROPIEDAD AJENA AGRAVADO POR EXPLOSIÓN">DAÑO EN PROPIEDAD AJENA AGRAVADO POR EXPLOSIÓN</option>
			<option value="DAÑO EN PROPIEDAD AJENA CULPOSO">DAÑO EN PROPIEDAD AJENA CULPOSO</option>
			<option value="DELITOS CONTRA EL AMBIENTE">DELITOS CONTRA EL AMBIENTE</option>
			<option value="DELITOS CONTRA LA INTIMIDAD Y LA IMAGEN">DELITOS CONTRA LA INTIMIDAD Y LA IMAGEN</option>
			<option value="DELITOS CONTRA INVIOLABILIDAD DEL SECRETO Y DE LOS SISTEMAS Y EQUIPO DE COMPUTO Y PROTECCIÓN DE LOS DATOS PERSONALES">DELITOS CONTRA INVIOLABILIDAD DEL SECRETO Y DE LOS SISTEMAS Y EQUIPO DE COMPUTO Y PROTECCIÓN DE LOS DATOS PERSONALES</option>
			<option value="DELITOS DE ABOGADOS">DELITOS DE ABOGADOS</option>
			<option value="DELITOS ELECTORALES">DELITOS ELECTORALES</option>
			<option value="DESPOJO, EJECUTADO CON VIOLENCIA.">DESPOJO, EJECUTADO CON VIOLENCIA.</option>
			<option value="EXTORSIÓN">EXTORSIÓN</option>
			<option value="FALSEDAD ANTE LAS AUTORIDADES">FALSEDAD ANTE LAS AUTORIDADES</option>
			<option value="FALSIFICACIÓN DE DOCUMENTOS">FALSIFICACIÓN DE DOCUMENTOS</option>
			<option value="FALSIFICAR SELLOS, MARCAS, LLAVE U OTROS OBJETOS.">FALSIFICAR SELLOS, MARCAS, LLAVE U OTROS OBJETOS.</option>
			...
			<option value="INCUMPLIMIENTO DE OBLIGACIONES DE ASISTENCIA FAMILIAR">INCUMPLIMIENTO DE OBLIGACIONES DE ASISTENCIA FAMILIAR</option>
			<option value="INHUMACIÓN Y EXHUMACIÓN DE CADÁVERES">INHUMACIÓN Y EXHUMACIÓN DE CADÁVERES</option>
			<option value="LESIONES (NAC)">LESIONES (NAC)</option>
			<option value="LESIONES CAUSADAS POR ANIMAL">LESIONES CAUSADAS POR ANIMAL</option>
			<option value="LESIONES POR CULPA">LESIONES POR CULPA</option>
			<option value="LOCALIZACIÓN DE PERSONA">LOCALIZACIÓN DE PERSONA</option>
			<option value="MALTRATO O CRUELDAD ANIMAL">MALTRATO O CRUELDAD ANIMAL</option>
			<option value="OMISIÓN DE CUIDADO">OMISIÓN DE CUIDADO</option>
			<option value="PELIGRO DE CONTAGIO DE SALUD">PELIGRO DE CONTAGIO DE SALUD</option>
			<option value="PERSONA DESAPARECIDA">PERSONA DESAPARECIDA</option>
			<option value="PORNOGRAFÍA DE PERSONA MENOR DE 18 AÑOS">PORNOGRAFÍA DE PERSONA MENOR DE 18 AÑOS</option>
			<option value="QUEBRANTAMIENTO DE SELLOS">QUEBRANTAMIENTO DE SELLOS</option>
			<option value="RECEPCIÓN U OCULTACIÓN DE BIENES PRODUCTO DE UN DELITO">RECEPCIÓN U OCULTACIÓN DE BIENES PRODUCTO DE UN DELITO</option>
			<option value="RESPONSABILIDAD MÉDICA Y TÉCNICA">RESPONSABILIDAD MÉDICA Y TÉCNICA</option>
			<option value="ROBO">ROBO</option>
			<option value="ROBO CALIFICADO A CASA HABITACIÓN">ROBO CALIFICADO A CASA HABITACIÓN</option>
			<option value="ROBO CALIFICADO A LUGAR CERRADO">ROBO CALIFICADO A LUGAR CERRADO</option>
			<option value="ROBO CALIFICADO DE DEPENDIENTE">ROBO CALIFICADO DE DEPENDIENTE</option>
			<option value="ROBO CON VIOELENCIA">ROBO CON VIOELENCIA</option>
			...
			<option value="USO DE DOCUMENTOS FALSOS">USO DE DOCUMENTOS FALSOS</option>
			<option value="USURPACIÓN DE FUNCIONES PÚBLICAS">USURPACIÓN DE FUNCIONES PÚBLICAS</option>
			<option value="USURPACIÓN DE PROFESIONES">USURPACIÓN DE PROFESIONES</option>
			<option value="SUPLANTACIÓN, USURPACIÓN DE IDENTIDAD.">SUPLANTACIÓN, USURPACIÓN DE IDENTIDAD.</option>
