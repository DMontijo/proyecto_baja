	...
	<div class="col-12">
		...
		<div class="card overflow-auto shadow rounded mb-5">
			<div class="card-body p-3 ">
				...
				<form id="form_datos" name="form_datos" class="row g-3 needs-validation" action="<?= base_url() ?>/denuncia/dashboard/actualizar-perfil" method="POST" enctype="multipart/form-data" novalidate>
					<div class="col-12 step">
						<div class="row">
							...
							<div class="col-12 text-center">
								<button class="btn btn-primary" type="submit" id="submit-btn-perfil"><i class="bi bi-check-circle-fill"></i> Actualizar</button>
							</div>
		...
		<div class="card overflow-auto shadow rounded mb-5">
			<div class="card-body p-3">
				...
				<form id="form_password" name="form_password" class="row g-3 needs-validation" action="<?= base_url() ?>/denuncia/dashboard/actualizar-password" method="POST" enctype="multipart/form-data" novalidate>
