			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-12 col-md-6 offset-md-3">
						<p class="fw-bolder">
							Recuerda que para atender los delitos de "Lorem ipsum dolor sit", "Lorem ipsum dolor sit",
							"Lorem ipsum dolor sit", "Lorem ipsum dolor sit", "Lorem ipsum dolor sit", es necesario
							comunicarte al 00000000000;
						</p>
					</div>
				</div>
			</div>
		...
		<div class="card rounded shadow">
			<div class="card-body p-0 py-3 p-sm-5">
				<div class="container">
					...
					<p class="text-center pb-5">Los campos con un <span class="asterisco-rojo">*</span> son obligatorios
					</p>
					<form action="<?= base_url() ?>/denuncia/dashboard/video-denuncia" class="row needs-validation" novalidate>
						...
						<div class="col-12 col-sm-6 col-md-6 col-lg-4">
							<label for="localidad" class="form-label fw-bold input-required">Localidad del
								delito:</label>
						...
						<div class="col-12 col-sm-6 col-md-6 col-lg-4">
							<label for="colonia-text" class="form-label fw-bold input-required">Colonia del
								delito:</label>
						...
						<div class="col-12 col-sm-6 col-md-6 col-lg-4">
							<label for="calle" class="form-label fw-bold input-required">Calle o avenida del
								delito:</label>
						...
						<div class="col-12 col-sm-6 col-md-6 col-lg-4">
							<label for="exterior" class="form-label fw-bold input-required">No. exterior del
								delito:</label>
						...
						<div class="col-12 col-sm-6 col-md-6 col-lg-4">
							<label for="fecha" class="form-label fw-bold input-required">Fecha y hora del
								delito:</label>
						...
						<div class="col-12 col-sm-6 col-md-6 col-lg-4">
							<label for="objetoImplicado-text" class="form-label fw-bold input-required">Describa el
								objeto implicado:</label>
						...
						<div class="col-12 text-center">
							<button class="btn btn-primary mt-5" type="submit"><i class="bi bi-camera-video-fill"></i>
								Iniciar denuncia</button>
						</div>
					</form>
				</div>
			</div>
