				...
				<div class="col-12 step">
					<div class="row">
						...
						<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
							...
							<input type="date" data-date="" data-date-format="DD MMMM YYYY" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" required max="<?= ((int)date("Y")) - 18 . '-' . date("m") . '-' . date("d") ?>">
							<div class="invalid-feedback">
