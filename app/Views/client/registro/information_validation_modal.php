		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-12">
						<div class="card shadow bg-blue mb-3">
							<div class="card-body text-white text-center">
								Verifica que todos tus datos esten correctos, de lo contrario cierra este mensaje y editalo nuevamente.
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-sm-6">
						<label for="sexo" class="form-label">Sexo biologico: </label>
					...
					<div class="col-12 col-sm-6">
						<label for="estadom" class="form-label">Estado del denunciante: </label>
					...
					<div class="col-12 col-sm-6">
						<label for="colonia_select" class="form-label">Colonia: </label>
						<input type="text" class="form-control" id="coloniam" name="coloniam" disabled>
					</div>

					<div class="col-12 col-sm-6">
						<label for="calle" class="form-label">Calle o avenida: </label>
					...
					<div class="col-12 col-sm-6">
						<label for="tel" class="form-label">Número de télefono: </label>
						<input type="text" class="form-control" id="telefonom" name="telefonom" disabled>
					</div>

					<div class="col-12 col-sm-6">
						<label for="tel2" class="form-label">Número de télefono 2: </label>
					...
					<div class="col-12 col-sm-6">
						<label for="numi" class="form-label">Número de identificacion: </label>
						<input type="text" class="form-control" id="numi" name="numi" disabled>
					</div>

					<div class="col-12 col-sm-6">
						<label for="edoc" class="form-label">Estado civil: </label>
					...
					<div class="col-12 col-sm-6">
						<label for="identificacion" class="form-label">Foto de identificacion: </label>
