<div class="row text-center mt-3">
    ...
    <div class="col-12">
        ...
        <button type="button" class="btn btn-secondary mb-3" id="limpiar_firma"><i class="bi bi-eraser-fill"></i>
    ...
    <div class="col-12">
        <textarea id="firma_url" hidden class="form-control" rows="5" required></textarea>
...
(function() {
    ...
    submitBtn.addEventListener("click", submitSignImage(e), false);
