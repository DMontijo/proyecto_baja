...
<script>
	...
	function enviar_datos() {
		...
		let numeroid = $("#numero_ide").val();
		let edoc = $("#e_civil").val();
		let ocupacion = $("#ocupacion").val();
		let orientacions = $("#orientacion").val();
		...
		$('#telefonomo').val(telefono2);
		$('#identificacionm').val(tipo);
		$('#numi').val(numeroid);
		$('#edocm').val(edoc);
		$('#ocupacionm').val(ocupacion);
		$('#discapacidadm').val(discapacidad);
		$('#orientacionm').val(orientacions);
		$('#idiomam').val(idioma);
