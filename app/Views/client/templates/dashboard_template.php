...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url() ?>/denuncia/dashboard"><img
                    src="<?= base_url() ?>/assets/img/FGEBC_SEJAP_LOGO.png" class="logo-header img-fluid"
                    alt="FGEBC Logo"></a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navegacion"
                aria-controls="navegacion" aria-expanded="false" aria-label="FGEBC navegación denuncia">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link <?php if ('' === 'dashboard' || '' === 'video-denuncia') echo 'active'; ?>"
                            href="<?= base_url() ?>/denuncia/dashboard"><i class="bi bi-camera-video"></i>
                            Denunciar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if ('' === 'denuncias') echo 'active'; ?>"
                            href="<?= base_url() ?>/denuncia/dashboard/denuncias"><i class="bi bi-archive"></i> Mis
                            denuncias</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="options">
                            ...
                            <li><a class="dropdown-item" href="<?= base_url() ?>/constancia_extravio/dashboard"><i
                                        class="bi bi-file-earmark"></i> Constancias</a></li>
                            <li><a class="dropdown-item" href="<?= base_url() ?>/denuncia/dashboard/perfil"><i
    ...
    <footer
        class="container-fluid text-center text-white bg-primary d-flex align-items-center justify-content-center footer py-3">
