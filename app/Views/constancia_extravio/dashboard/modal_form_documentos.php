    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0" style="border-radius: 1.5em;">
            <div class="modal-header bg-primary justify-content-center" style="border-radius: 1.5em 1.5em 0 0;">
                <h3 class="modal-title text-white fw-bold" id="documentos_modalLabel">Constancia de extravío de documentos</h3>
            </div>
            <div class="modal-body fs-5 text-center">
                <form action="<?= base_url() ?>/constancia_extravio/dashboard/solicitar_constancia" method="post" enctype="multipart/form-data" class="row needs-validation" novalidate>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                        ...
                        <select class="form-select" id="estadoD" name="estado" required>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                        ...
                        <select class="form-select" id="municipioD" name="municipio" required>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                        <label for="apellido_m" class="form-label fw-bold input-required">No. documento:</label>
                        <input class="form-control" type="text" id="nodocumento" name="nodocumento">
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                        <label for="apellido_m" class="form-label fw-bold">¿El documento está al nombre del solicitante?</label>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                        <label for="apellido_m" class="form-label fw-bold input-required">Apellido paterno:</label>
                        <input class="form-control" type="text" id="duenoapdoc" name="duenoapdoc">
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                        <label for="apellido_m" class="form-label fw-bold input-required">Apellido materno:</label>
...
<script>
    document.querySelector('#estadoD').addEventListener('change', (e) => {
        let select_municipio = document.querySelector('#municipioD');
...
<script>
    ...
    solicitante.addEventListener('change', function() {
        ...
        document.getElementById("duenonamedoc").disabled = true;
        document.getElementById("duenoapdoc").disabled = true;
        document.getElementById("duenoamdoc").disabled = true;
