<div class="modal fade" id="boletos_modal" tabindex="-1" aria-labelledby="boletos_modalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
	<div class="modal-dialog modal-lg modal-dialog-centered modal-xl">
		<div class="modal-content border-0">
			...
			<div class="modal-body bg-light">
				<form action="<?= base_url() ?>/constancia_extravio/dashboard/solicitar_constancia" method="post" class="row needs-validation" novalidate>
					...
					<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
						...
						<input class="form-control" type="text" id="domicilio" name="domicilio" maxlength="300" required>
						<div class="invalid-feedback">
					...
					<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
						<label for="apellido_m" class="form-label fw-bold input-required">Permiso de
							gobernación:</label>
						<input class="form-control" type="text" id="permisoGobernacion" name="permisoGobernacion" required>
						<div class="invalid-feedback">
