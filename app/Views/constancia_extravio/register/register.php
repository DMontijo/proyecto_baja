...
<div class="container m-auto ">
    <div class="card shadow py-4 px-3 border-0">
        <div class="card-body">
            ...
            <form id="form_register" name="form_register" class="row g-3 needs-validation py-5"
                action="<?= base_url() ?>/constancia_extravio/create" method="POST" novalidate>
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text" id="correo_vanity"><i
                                        class="bi bi-envelope-fill"></i></span>
                                <input type="email" class="form-control" name="correo" id="correo"
                                    aria-describedby="correo_vanity" maxlength="100" required>
                            </div>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                            <label for="fecha_nacimiento" class="form-label fw-bold input-required">Fecha de
                                nacimiento</label>
                            <input type="date" data-date="" data-date-format="DD MMMM YYYY" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento"
                                required max="<?= ((int)date("Y")) - 18 . '-' . date("m") . '-' . date("d") ?>">
                            <div class="invalid-feedback">
                ...
                <div class="col-12 mt-5 text-center">
                    <button class="btn btn-primary" type="submit" id="submit-btn"><i
                            class="bi bi-check-circle-fill"></i> Registrarme</button>
                </div>
            </form>
        </div>
    </div>
