	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content border-0">
			<div class="modal-header bg-primary justify-content-center">
				<h5 class="modal-title text-white font-weight-bold" id="password_modalLabel">Ingresa tu contraseña</h5>
				<h5 class="modal-title text-white font-weight-bold d-none" id="password_verifying">Verificando tu contraseña</h5>
			</div>
			<div class="modal-body text-center" id="load">
				<form method="POST" action="<?php echo base_url('admin/dashboard/firma') ?>" class="needs-validation row" novalidate>
					<div class="col-12 mb-3">
						...
						<label for="contrasena" class="form-label font-weight-bold input-required">Contraseña:</label>
						<input class="form-control" id="contrasena" name="contrasena" type="password" required>
					</div>
					<div class="col-12">
						<button type="submit" class="btn btn-secondary font-weight-bold">Validar contraseña</button>
					</div>
				</form>
			</div>
