<form id="form_objetos_involucrados_update" action="" method="post" class="row p-0 m-0 needs-validation" novalidate>
...
<script>
	...
	selectObjetoClasificacionDa.addEventListener("change", function() {
				...
				var datos = {
					"objeto_clasificacion_id": selectObjetoClasificacionDa.value,
				}
