<div class="modal fade shadow" id="folio_persona_fisica_modal_da" tabindex="-1" role="dialog" aria-labelledby="personaFisicaModalLabel" aria-hidden="true" data-backdrop="false">
				...
				<div class="tab-content" id="persona_content">
					<div class="tab-pane fade py-3 show active" id="home" role="tabpanel" aria-labelledby="persona">
						<div class="container_tab" style="height:70vh;overflow-y:scroll;">
							<?= view('admin/dashboard/modals_denuncia_anonima/form_persona_fisica') ?>
						</div>
					</div>

					<div class="tab-pane fade py-3" id="profile" role="tabpanel" aria-labelledby="domicilio">
						<div class="container_tab" style="height:70vh;overflow-y:scroll;">
							<?= view('admin/dashboard/modals_denuncia_anonima/form_domicilio') ?>
						</div>
					</div>
					<div class="tab-pane fade py-3" id="nav-media-filiacion" role="tabpanel" aria-labelledby="nav-media-filiacion-tab">
						<div class="container_tab" style="height:70vh;overflow-y:scroll;">
							<?= view('admin/dashboard/modals_denuncia_anonima/form_media_filiacion') ?>
						</div>
					</div>
				</div>
			</div>
