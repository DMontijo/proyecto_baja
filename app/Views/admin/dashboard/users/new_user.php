...
<section class="content">
    ...
    <div class="card shadow border-0 rounded">
        <div class="card-body">
            <form class="g-3 needs-validation" action="<?= base_url() ?>/admin/dashboard/nuevo_usuario" method="POST"
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                        ...
                        <input autocomplete="off" type="text" name="nombre_usuario" class="form-control"
                            id="nombre_usuario" placeholder="Escribe el nombre" required>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                        ...
                        <input autocomplete="off" type="text" name="apellido_paterno_usuario" class="form-control"
                            id="apellido_paterno_usuario" placeholder="Escribe el apellido paterno" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input autocomplete="off" class="form-check-input" type="radio" name="sexo_usuario"
                                value="M" required>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input autocomplete="off" type="email" name="correo_usuario" class="form-control"
                                id="correo_usuario" placeholder="Correo electrónico" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
                        ...
                        <input autocomplete="off" type="password" name="password_usuario" class="form-control"
                            id="password_usuario" placeholder="Escribe la contraseña" required>
                        <div class="invalid-feedback">
