            ...
            <div class="col-md-12">
                ...
                <div class="card shadow border-0 rounded">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <a type="button" id="new_user" href="<?= base_url('/admin/dashboard/nuevo_usuario') ?>"
                                ...
                                <table id="table-usuarios" class="table table-bordered table-striped"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $user->NOMBRE_ZONA ? $user->NOMBRE_ZONA : '' ?>
                                            </td>
                                            <td class="text-center">
                                                <?= $user->MUNICIPIODESCR ? $user->MUNICIPIODESCR : '' ?></td>
                                            <td class="text-center">
                                                <?= $user->OFICINADESCR ? $user->OFICINADESCR : '' ?></td>
                                            ...
                                            <td class="text-center">
                                                <a type="button" class="btn btn-success"
                                                    href="<?= base_url('admin/dashboard/editar_usuario?id=' . $user->ID) ?>">
