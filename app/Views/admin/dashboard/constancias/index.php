		...
		<div class="row">
			...
			<div class="col-12 col-sm-6 col-md-4 col-lg-3">
				<div class="card shadow border-0 text-center">
					<div class="card-body p-2" style="height:200px;">
						<a href="<?= base_url('admin/dashboard/constancias_extravio_abiertas') ?>" class="btn btn-primary btn-block h-100 d-flex flex-column justify-content-center align-items-center font-weight-bold">
			...
			<?php if (in_array(session('ROLID'), $rolesToMonitor)) { ?>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3">
					<div class="card shadow border-0 text-center">
						<div class="card-body p-2" style="height:200px;">
							<a href="<?= base_url('admin/dashboard/constancias_extravio_proceso') ?>" class="btn btn-primary btn-block h-100 d-flex flex-column justify-content-center align-items-center d-flex flex-column justify-content-center align-items-center font-weight-bold">
								<i class="fas fa-box-open"></i> En proceso <br><br> <span class="font-weight-bold" style="font-size:20px;"><?= $body_data->proceso ?></span>
							</a>
						</div>
					</div>
				</div>
