        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card shadow border-0" style="overflow-x:auto;">
                    <div class="card-body">
                        <table id="extravios_abiertos" class="table table-bordered table-striped" data-page-length='50'
                            style="width:100%">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a type="button"
                                            ...
                                            class="btn btn-primary text-white"><i class="fas fa-eye"></i> VER
                                            SOLICITUD</a></td>
                                    <?php } ?>
                                    <?php if ($constancia->STATUS == 'FIRMADO') { ?>
                                    <td class="text-center">
                                        <form class="d-inline-block" method="POST"
                                            action="<?php echo base_url('admin/dashboard/download_constancia_pdf') ?>">
                                        ...
                                        <form class="d-inline-block" method="POST"
                                            action="<?php echo base_url('admin/dashboard/download_constancia_xml') ?>">
                                            <input type="text" class="form-control" id="folio" name="folio"
                                                value="<?= $constancia->CONSTANCIAEXTRAVIOID ?>" hidden>
                                            <input type="text" class="form-control" id="year" name="year"
                                                value="<?= $constancia->ANO ?>" hidden>
