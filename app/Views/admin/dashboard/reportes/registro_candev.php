                    ...
                    <div class="card-body" style="overflow-x:auto;">
						<div class="row mb-3">
                            <div class="col-12 d-flex justify-content-center align-items-center">
                                ...
                                <form id="formExcel"
                                    action="<?= base_url() ?>/admin/dashboard/generar_excel_canadev" method="post"
                            ...
                            <tbody>
								...
								?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?=  isset($orden->EXPEDIENTEID) ? $array[2].$array[4].$array[5].'-'.$array[6].$array[7].$array[8].$array[9].'-'.$array[10].$array[11].$array[12].$array[13].$array[14] : ''?></td>
