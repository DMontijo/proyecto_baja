<div class="modal fade shadow" id="agregar_archivos_modal" role="dialog" aria-labelledby="agregar_archivos_modal" aria-hidden="true" data-backdrop="">
					...
					<div class="tab-pane fade show active" id="nav-archivo" role="tabpanel" aria-labelledby="nav-archivo-tab">
						<div class="row" style="font-size:10px;">
							<div class="col-12 col-sm-6 offset-sm-3">
								...
								<button type="button" class="btn-sm btn-primary" style="width: 100%;" id="btnSubirArchivos">Subir documento</button>
							</div>
						</div>
					</div>
