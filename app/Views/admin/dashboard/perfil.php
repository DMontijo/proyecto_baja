                ...
                <div class="col-12">
                    <div class="card shadow border-0 rounded">
                        <div class="card-body">
                            ...
                            <?php if (file_exists($directory . '/' . $file_key) && file_exists($directory . '/' . $file_cer)) : ?>
                            <p class="text-center font-weight-bold text-success">YA EXISTE UNA FIEL CARGADA</p>
                            <?php endif; ?>
                            <form id="form_fiel" class="row needs-validation"
                                action="<?= base_url() ?>/admin/dashboard/charge_fiel" method="POST"
                                enctype="multipart/form-data" novalidate>
                                <div class="col-12 col-md-6 mb-3">
                                    <label class="form-label font-weight-bold" for="key">Archivo .key</label>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="key" name="key" accept=".key"
                                            required>
                                        <label class="custom-file-label" for="key" id="key_label">Seleccionar archivo
                                            key</label>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="cer" name="cer" accept=".cer"
                                            required>
                                        <label class="custom-file-label" for="cer" id="cer_label">Seleccionar archivo
                                            cer</label>
                                        <div class="invalid-feedback">
                ...
                <div class="col-12">
                    <div class="card shadow border-0 rounded">
                        <div class="card-body">
                            ...
                            <form id="form_password" class="g-3 needs-validation"
                                action="<?= base_url() ?>/admin/dashboard/update_password" method="POST"
                                enctype="multipart/form-data" novalidate>
                                <div class="row">
                                    <div class="col-12 col-sm-6 mb-3">
                                        <label for="password" class="font-weight-bold">Nueva contraseña</label>
                                        <input autocomplete="off" type="password" name="password" class="form-control"
                                            id="password" placeholder="Escribe la contraseña" required>
                                        <div class="invalid-feedback">
                                            La contraseña es obligatoria
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 mb-3">
                                        <label for="password_confirm" class="font-weight-bold">Confirmar nueva
                                            contraseña</label>
                                        <input autocomplete="off" type="password" name="password_confirm"
