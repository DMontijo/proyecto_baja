			...
			<div class="col-md-12">
				...
				<div class="card shadow border-0 rounded">
					<div class="card-body">
						<div class="row">
							<div class="col-12">
								<a type="button" id="new_rol" href="<?= base_url('/admin/dashboard/nuevo_rol') ?>" class="btn btn-primary float-right">
									<i class="fas fa-user-plus mr-3"></i> Nueva asignación de permisos
								</a>
							</div>
										...
										<?php foreach ($body_data->rolPermisoDescr as $index => $rolpermiso) { ?>
											<tr>
												...
												<td class="text-center">
													<a type="button" class="btn btn-danger" href="<?= base_url('admin/dashboard/eliminar_rol?rol=' . $rolpermiso['ROLID'].'&permiso='. $rolpermiso['PERMISOID']) ?>">
