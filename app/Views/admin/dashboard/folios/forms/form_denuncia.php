<div class="row">
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		...
		<select class="form-control" id="delito_delito" name="delito_delito" required>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		...
		<input type="date" data-date="" data-date-format="DD MMMM YYYY" class="form-control" id="fecha_delito" name="fecha_delito" required max="<?= date("Y-m-d") ?>">
	</div>
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
