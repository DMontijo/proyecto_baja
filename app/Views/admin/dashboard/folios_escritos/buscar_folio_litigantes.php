						...
						<div id="accordion">
							<div class="card m-0">
								...
								<div id="filtros" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
									<div class="card-body">
										<form action="<?= base_url() ?>/admin/dashboard/buscar_folio_litigante" method="post" enctype="multipart/form-data" class="row needs-validation" novalidate>
									...
									<tbody>
										...
										?>
											...
											<tr>
												...
												<td class="text-center">
													<a href="<?= base_url('/admin/dashboard/denuncia-escrita?folio=') . $folio->FOLIOID . '&year=' . $folio->ANO ?>" class="btn btn-primary text-white btn-sm"><i class="fas fa-user-check"></i> ATENDER</a>
												</td>
