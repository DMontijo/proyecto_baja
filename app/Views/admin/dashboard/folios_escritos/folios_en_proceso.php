	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-12 text-center mb-4">
				<h1 class="mb-4 text-center font-weight-bold">FOLIOS EN PROCESO (DENUNCIA ESCRITA)</h1>
								...
								<?php foreach ($body_data->folio as $index => $folio) { ?>
									<tr>
										...
										<td class="text-center">
											<form id="<?= 'form_' . $folio->FOLIOID ?>" action="<?= base_url('admin/dashboard/liberar_folio_escrita') ?>" name="formulario_liberacion" method="POST" onsubmit="return confirmarLiberacion(event,this)">
