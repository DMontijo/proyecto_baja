...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h3 class="mb-4"><?php echo $body_data->constanciaVideoD[1]->TITULO ?></h3>
                <input type="button" class="btn btn-primary btn-block py-2 mb-2 font-weight-bold" onclick="printDiv();" value="Imprimir" />
                <div class="card shadow border-0">
                    <div class="card-body" id="videoD" style="margin: 2%;">
                        <h5><?php echo $body_data->constanciaVideoD[1]->PLACEHOLDER ?></h5>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    function printDiv() {
        ...
        mywindow.document.write(document.getElementById('videoD').innerHTML);
