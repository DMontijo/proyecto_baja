    ...
    <section class="row">
        ...
        <div class="col-sm-4 col-md-3 d-none d-lg-block">
            <div class="card text-center bg-transparent border-0">
                <div class="card-body">
                    <a href="" class="text-decoration-none">
                        <img src="<?=base_url()?>/assets/img/icons/consulta_ciudadana.png" class="w-75"
                            alt="Consulta ciudadana de expediente">
        ...
        <div class="col-sm-4 col-md-3 d-none d-lg-block">
            <div class="card text-center bg-transparent border-0">
                <div class="card-body">
                    <a href="" class="text-decoration-none">
                        <img src="<?=base_url()?>/assets/img/icons/buzon_visitaduria.png" class="w-75"
        ...
        <div class="col-sm-4 col-md-3 d-none d-lg-block">
            <div class="card text-center bg-transparent border-0">
                <div class="card-body">
                    <a href="" class="text-decoration-none">
                        <img src="<?=base_url()?>/assets/img/icons/personas_no_localizadas.png" class="w-75"
        ...
        <div class="col-sm-4 col-md-3 d-none d-lg-block">
            <div class="card text-center bg-transparent border-0">
                <div class="card-body">
                    <a href="https://consultapublicamx.plataformadetransparencia.org.mx/vut-web/faces/view/consultaPublica.xhtml?idEntidad=MDI=&idSujetoObligado=MTM4MTA=#inicio"
