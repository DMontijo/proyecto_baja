<?= $this->extend('denuncia_litigantes/templates/login_template') ?>
							...
							<div class="col-12 col-lg-10 offset-lg-1">
								<div class="card bg-blue shadow-lg">
									<div class="card-body text-center">
										...
										<a href="<?= base_url() ?>/denuncia_litigantes/register" class="btn btn-light">
											REGÍSTRATE
										</a>
									</div>
								</div>
						...
						<div class="row align-items-center justify-content-center">
							<div class="col-12 col-lg-10 offset-lg-1">
								<div class="card shadow-lg py-3 px-3" style="background: rgba(255,255,255,0.8);">
									<h2 class="fw-bolder text-white text-center text-blue mb-2">Si ya tienes una cuenta para generar denuncias ingresa.</h2>
									<div class="card-body">
										...
										<?php endif; ?>
										<form id="client_login_form" action="<?= base_url("denuncia_litigantes/login_auth") ?>" method="post" class="row g-3 needs-validation" novalidate>
											<div class="col-12">
