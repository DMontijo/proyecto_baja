...
<div class="container m-auto">
	...
	<div class="card shadow py-4 px-3 border-0">
		<div class="card-body">
			...
			<form id="form_register" name="form_register" class="row g-3 needs-validation py-5" action="<?= base_url() ?>/denuncia_litigantes/create" method="POST" enctype="multipart/form-data" novalidate>
		...
		switch (step) {
			...
			case 3:
				if (
					...
					document.querySelector('#numero_cedula').value != '' &&
...
<script>
	function enviar_datos() {
		...
		let numeroid = document.querySelector("#numero_cedula").value ? document.querySelector("#numero_cedula").value : '';
