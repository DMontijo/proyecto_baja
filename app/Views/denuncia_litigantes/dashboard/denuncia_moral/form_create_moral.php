...
<h3 class="fw-bold text-center text-blue pb-3">Persona moral</h3>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		...
		<input class="form-control" type="text" id="razon_social_c" name="razon_social_c" required>
		<div class="invalid-feedback">
			La razón social es obligatorio
		</div>
	</div>
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		<label for="marca_comercial_c" class="form-label fw-bold">Marca comercial:</label>
		<input class="form-control" type="text" id="marca_comercial_c" name="marca_comercial_c">
		<div class="invalid-feedback">
			La marca comercial es obligatorio
		</div>
	</div>
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		<label for="rfc_c" class="form-label fw-bold input-required">RFC:</label>
		<input class="form-control" type="text" id="rfc_c" name="rfc_c" required>
		<div class="invalid-feedback">
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-3">
		...
		<select class="form-select" id="giro_empresa_c" name="giro_empresa_c" required>
...
<script>
    ...
    document.querySelector('#rfc_c').blur();
    ...
    document.querySelector('#rfc_c').addEventListener('blur', (e) => {
