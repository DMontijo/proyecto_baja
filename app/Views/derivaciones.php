...
<div class="container">
	...
	<nav>
		<div class="nav nav-tabs" id="nav-tab" role="tablist">
			<button class="nav-link fw-bolder active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-tijuana" type="button" role="tab" aria-controls="nav-home" aria-selected="true">TIJUANA</button>
			...
			<button class="nav-link fw-bolder" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-mexicali" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">MEXICALI</button>
		</div>
	</nav>
				...
				<tbody>
					<?php foreach ($body_data->derivacionesTijuana as $index => $derivacion) { ?>
						<tr>
							...
							<td><?= $derivacion->INSTITUCIONREMISIONDESCR ?></td>
