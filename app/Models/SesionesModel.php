...
class SesionesModel extends Model
{
	...
	{
		$strQuery = 'SELECT SESIONES.ID_USUARIO, SESIONES.IP_USUARIO, SESIONES.AGENTE_HTTP, SESIONES.AGENTE_SO, SESIONES.FECHAINICIO, USUARIOS.NOMBRE, USUARIOS.APELLIDO_PATERNO
		FROM SESIONES 
