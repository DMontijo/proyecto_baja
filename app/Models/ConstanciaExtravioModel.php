...
class ConstanciaExtravioModel extends Model
{
	...
	public function filterDates($obj)
	{
		...
		MUNICIPIOCITA.MUNICIPIODESCR AS MUNICIPIOCITA
		...
		INNER JOIN MUNICIPIO AS MUNICIPIOCITA ON MUNICIPIOCITA.MUNICIPIOID = CONSTANCIAEXTRAVIO.MUNICIPIOIDCITA AND MUNICIPIOCITA.ESTADOID = CONSTANCIAEXTRAVIO.ESTADOID
