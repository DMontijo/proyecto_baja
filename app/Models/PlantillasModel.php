...
class PlantillasModel extends Model
{
	...
	{
		$sql = 'SELECT FD.FOLIOID, FD.TIPODOC, FD.FECHAFIRMA, MU.MUNICIPIODESCR, US.NOMBRE AS NOMBRE_MP, US.APELLIDO_PATERNO AS APATERNO_MP, US.APELLIDO_MATERNO AS AMATERNO_MP, FO.HECHODELITO, FO.EXPEDIENTEID, FPS.NOMBRE, FPS.PRIMERAPELLIDO, FPS.SEGUNDOAPELLIDO, FPS.SEXO, FPS.EDADCANTIDAD, FP.LESIONES
		FROM FOLIODOC AS FD 
