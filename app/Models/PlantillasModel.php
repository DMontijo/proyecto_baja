...
class PlantillasModel extends Model
{
	...
	public function filtro_ordenes_proteccion_banavim($bindParams)
	{
		...
		AND DELMOD.DELITOMODALIDADDESCR LIKE "%AMENAZAS%"
		AND DELMOD.DELITOMODALIDADDESCR LIKE "%ESTUPRO%"
		AND DELMOD.DELITOMODALIDADDESCR LIKE "%VIOLENCIA FAMILIAR%"
		AND DELMOD.DELITOMODALIDADDESCR LIKE "%TRATA%"
		AND DELMOD.DELITOMODALIDADDESCR LIKE "%HOSTIGAMIENTO SEXUAL%"
		AND DELMOD.DELITOMODALIDADDESCR LIKE "%VIOLACION%"
		AND DELMOD.DELITOMODALIDADDESCR LIKE "%PEDERASTIA%"
		AND DELMOD.DELITOMODALIDADDESCR LIKE "%LESIONES CALIFICADAS%"
		AND DELMOD.DELITOMODALIDADDESCR LIKE "%ABUSO SEXUAL%"
