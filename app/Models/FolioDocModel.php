...
class FolioDocModel extends Model
{
	...
	public function get_by_folio($folio, $year)
	{
		...
		$builder->select(['FOLIOID', 'FOLIODOCID', 'ANO', 'TIPODOC', 'STATUS', 'PLACEHOLDER', 'STATUSENVIO', 'ENVIADO', 'AGENTE_REGISTRO.NOMBRE AS AGENTER_NOMBRE', 'AGENTE_REGISTRO.APELLIDO_PATERNO AS AGENTER_AP', 'AGENTE_REGISTRO.APELLIDO_MATERNO AS AGENTER_AM',
