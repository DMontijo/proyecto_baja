...
class ConexionesDBSeeder extends Seeder
{
	public function run()
	{
		$data = [
			...
			array('TYPE' => 'production', 'ESTADOID' => '2', 'MUNICIPIOID' => '1,', 'USER' => 'DBO', 'PASSWORD' => 'dba0wner', 'IP' => '172.16.200.18', 'INSTANCE' => 'PGJEENS', 'SCHEMA' => 'DBO'),
			array('TYPE' => 'production', 'ESTADOID' => '2', 'MUNICIPIOID' => '2,', 'USER' => 'DBO', 'PASSWORD' => 'dba$$##2020', 'IP' => '172.16.24.136', 'INSTANCE' => 'PGJE', 'SCHEMA' => 'DBO'),
