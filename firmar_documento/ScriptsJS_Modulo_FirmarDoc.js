...
function FIEL_DirectSign() {
	// FUNCION DE FIRMA DIRECTA
...
function Display_Document(resp) {
	...
	CodHTML +=
		'<table border="1" cellpadding="8" cellspacing="0" style="width: 550px; margin-top: 20px;" class="EstiloBordeFino">';

	CodHTML += "<tr>";

	CodHTML +=
		'<td align="center" valign="top" style="width: 160px;" rowspan="2">';
	CodHTML +=
		'<img src="' +
		resp.NomArchPNG +
		'" width="150" height="150" alt="CodQR"/>';
	CodHTML += "</td>";

	CodHTML +=
		'<td align="center" valign="top" style="width: auto; padding-top: 4px;">';

	CodHTML +=
		'<table border="0" cellpadding="1" cellspacing="0" style="width: 100%">';
	CodHTML += "<tr>";
	CodHTML +=
		'<td align="left" valign="middle" style="width: 28%; font-size: 13pt; height: 40px;">';
	CodHTML +=
		'<input type="button" value="Imprimir documento firmado" onclick="ImprDocPDF(\'' +
		resp.NomArchPDF +
		'\');" class="myButtonVerde" style="width: 340px;"/>';
	CodHTML += "</td>";
	CodHTML += "</tr>";
	CodHTML += "<tr>";
	CodHTML +=
		'<td align="left" valign="middle" style="font-size: 13pt; height: 40px;">';
	CodHTML +=
		'<input type="button" value="Descargar archivos del documento firmado" onclick="DescargarDocFirmado(\'' +
		resp.NomArchZIP +
		'\');" class="myButtonAzul" style="width: 340px;"/>';
	CodHTML += "</td>";
	CodHTML += "</tr>";
	CodHTML += "</table>";
...
function Display_Error(error) {
	...
	if (error.StatusVigencia === "CADUCO") {
		CodHTML +=
			'<table border="1" cellpadding="5" cellspacing="0" style="width: 400px; margin-top: 20px;" class="EstiloBordeFino">';
		CodHTML += "<tr>";
		CodHTML +=
			'<td valign="middle" height="" align="left" style="width: 130px;">';
		CodHTML +=
			'<img src="images/Exclamacion.png" width="120" height="120" alt="Exclamacion"/>';
		CodHTML += "</td>";
		CodHTML +=
			'<td valign="middle" height="" align="left" style="width: auto; font-size: 14pt;">';
	...
	if (
		error.Valid_ApertArchsFIEL === 0 &&
		error.Valid_EsFIEL === 0 &&
		error.Valid_ObtenDatsFIEL === 0
	) {
		...
		CodHTML +=
			'<table border="1" cellpadding="8" cellspacing="0" style="width: 650px; margin-top: 20px;" class="EstiloBordeFino">';

		CodHTML += "<tr>";

		CodHTML +=
			'<td align="center" valign="top" style="width: 120px;" rowspan="2">';
		CodHTML +=
			'<img src="images/bien_120x120.png" width="100" height="100" alt="bien_120x120"/>';
		CodHTML += "</td>";

		CodHTML +=
			'<td align="left" valign="top" style="width: auto; padding-top: 4px;">';

		CodHTML +=
			'<table border="0" cellpadding="1" cellspacing="0" style="width: 450px">';
		CodHTML += "<tr>";
		CodHTML +=
			'<td align="left" valign="top" style="color: #006B1B; font-size: 17pt; padding-bottom: 10px;" colspan="2" >';
		CodHTML += "Datos obtenidos de la FIEL.";
		CodHTML += "</td>";
		CodHTML += "</tr>";
		CodHTML += "<tr>";
		CodHTML +=
			'<td align="left" valign="top" style="width: 27%; font-size: 13pt;">';
		CodHTML += "RFC:";
		CodHTML += "</td>";
		CodHTML +=
			'<td align="left" valign="top" style="width: 73%; font-size: 13pt; color: #000099;">';
		CodHTML += RFC;
		CodHTML += "</td>";
		CodHTML += "</tr>";
		CodHTML += "<tr>";
		...
		CodHTML += "</td>";
		CodHTML +=
			'<td align="left" valign="top" style="font-size: 13pt; color: #000000;">';
		CodHTML += Nombre;
		CodHTML += "</td>";
		CodHTML += "</tr>";
		CodHTML += "<tr>";
		...
		CodHTML += "</td>";
		CodHTML +=
			'<td align="left" valign="top" style="font-size: 13pt; color: #A70202;">';
		CodHTML += NoCert;
		CodHTML += "</td>";
		CodHTML += "</tr>";
		CodHTML += "</table>";
...
function FIEL_uploadProgress(e) {
	...
	if (e.lengthComputable) {
		...
		document.getElementById(
			"FIEL_b_transfered"
		).innerHTML = iBytesTransfered;
		if (iPercentComplete === 100) {
			var oUploadResponse = document.getElementById(
				"FIEL_upload_response"
			);
			oUploadResponse.innerHTML = "Espere, procesando...";
			oUploadResponse.style.display = "block";
		}
	} else {
		document.getElementById("FIEL_progress").innerHTML =
			"unable to compute";
	}
}

function FIEL_uploadError(e) {
	// upload error
	alert(e);
...
function FirmarDoc() {
	...
	CodHTML += "<tr>";
	CodHTML +=
		'<td align="left" valign="middle" style="width: 100px; height: 80px;">';
	CodHTML += '<img src="images/loader.gif" width="100" alt="loader"/>';
	CodHTML += "</td>";
	CodHTML +=
		'<td align="left" valign="middle" style="width: auto; font-size: 13pt; color: #5C5C5C; padding-left: 18px;">';
	CodHTML += "Espere...";
	CodHTML += "</td>";
	CodHTML += "</tr>";
	CodHTML += "</table>";
