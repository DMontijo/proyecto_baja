...
function CSD_VerifArchsKeyCer(){
    ...
    CreateXmlHttp();
    var ajaxRequest = "ScriptPHP_VerifArchsKeyCer_3.3.php?IdEmpr="+Ini_IdEmpr+"&ClaSuc="+Ini_ClaSuc+"&ClaveSellos="+ClaveSellos;
...
//        alert(xmlHttp.responseText);
        ...
        if (StatusArchKEY===1 || StatusArchCER===1 || RFC.length===0){
            ...
            if (ValidModulus===1){
                ...
                document.getElementById("ModLoc").style.width = "650px"; // <-- Ancho
                document.getElementById("ModLoc").style.height = "160px"; // <-- Alto
                document.getElementById("ModLoc").style.overflowX = "hidden";
                document.getElementById("ModLoc").style.overflowY = "hidden";
                document.getElementById("MarcMod").style.width = "685px"; // +35
                document.getElementById("MarcMod").style.height = "170px"; // + 10

                OpenWin('MarcMod');

                Mod_VentEmerg = 1;

                document.getElementById("ModLoc").innerHTML = CodHTML;
...
document.getElementById("ContCargCSD").style.height = ($(window).height()-80) + "px";
document.getElementById("CargCSD_Cont").style.height = ($(window).height()-163) + "px";
document.getElementById("ContMod_CargCSD").style.display = "block";
document.getElementById("ProgreesBar_CargMod").style.display = "none";
